...
## Запускаемый fake pipeline

В [`examples/README.md`](../../examples/README.md) находятся отдельные программы
клиента и сервера, использующие только публичные фасады. Детерминированный
loopback-сценарий показывает активацию, fake STT/LLM/TTS, потоковый PCM, учёт
воспроизведения, отмену через barge-in, re-arm и чистое завершение без устройств
и внешних сервисов.
